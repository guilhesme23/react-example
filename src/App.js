...
class App extends Component {
  render() {
    return <div>
        <ImageSection source="img/city3.jpeg" content="React Example" height="100vh" border={true} />
        ...
        <ImageSection source="img/city2.jpeg" content="Some text here" height="40vh" border={false} />
        ...
        <ImageSection source="img/city1.jpeg" content="More text here" height="40vh" border={false} />
        ...
        <ImageSection source="img/city3.jpeg" content="By Guilherme Marques" height="100vh" border={true} />
      </div>;
  }
}
